...
namespace PubPay.Common.Alipay
{
    ...
    public sealed class RSAFromPkcs8
    {
        ...
        /// <param name="input_charset">编码格式</param>
        /// <returns></returns>
        public static string RSASignKeyFromFile(string data, string privateKeyFile, string charset)
        {
            RSACryptoServiceProvider rsaCsp = LoadCertificateFile(GetFileName(privateKeyFile));
